...
public class Ensyu13_1 {
	...
	public static void main(String[] args) {
		...
		// figureQuantityの値が0の場合、判断
		if (figureQuantity == 0) {
			// 「何も表示しません」を表示
			System.out.println("何も表示しません。");
		}
