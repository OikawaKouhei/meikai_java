...
public class Ensyu14_1 {
	...
	public static void main(String[] args) {
		...
		for (int firstCount = 0; firstCount < figureQuantity; firstCount++) {
			...
			case 1:
				putShape[firstCount] = new Point();
				// スイッチ文を抜ける
				break;
			// selecyNumberの値が2の場合、メソッドinputNumberの返り値の値を引数とし、インスタンス化
			case 2:
				putShape[firstCount] = new HorizontalLine(inputNumber("長さ："));
				// スイッチ文を抜ける
				break;
			// selecyNumberの値が3の場合、メソッドinputNumberの返り値の値を引数とし、インスタンス化
			case 3:
				putShape[firstCount] = new VirticalLine(inputNumber("長さ："));
				// スイッチ文を抜ける		
				break;
			// selecyNumberの値が4の場合、メソッドinputNumberの返り値の値2つを引数とし、インスタンス化
			case 4:
				putShape[firstCount] = new Rectangle(inputNumber("幅："), inputNumber("高さ："));
				// スイッチ文を抜ける		
				break;
			// selecyNumberの値が5の場合、メソッドinputNumberの返り値の値2つを引数とし、インスタンス化
			case 5:
				putShape[firstCount] = new Parallelogram(inputNumber("幅："), inputNumber("高さ："));
				// スイッチ文を抜ける	
				break;
			}
		}
